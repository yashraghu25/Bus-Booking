...
class bus_booking:
    ...
    def home_page(self):
        ...
        def home_to_db_add_page():
            ...
            Button(root,text='Seat Booking',bg='pale green',font=( "Arial bold",15),command=home_to_jouney_detail).grid(row=5,column=4,padx=(180,50))
            Button(root,text='Checked Booked Seat',bg='lime green',font=("Arial bold",15),command=home_to_check_booking).grid(row=5,column=5,padx=30)
            Button(root,text='Add Bus Details',bg='forest green',font=("Arial bold",15),command=home_to_db_add_page).grid(row=5,column=6,pady=20)
    ...
    def db_add_page(self):
        ...
        Button(frame1,text='New Operator',font=("Arial bold",12),bg='spring green',command=db_add_to_add_op).grid(row=3,column=1,padx=(0,30))
        Button(frame1,text='New Bus',font=("Arial bold",12),bg='orange',command=db_add_to_add_bus).grid(row=3,column=2,padx=30)
        Button(frame1,text='New Route',font=("Arial bold",12),bg='medium orchid',command=db_add_to_add_route).grid(row=3,column=3,padx=30)
        Button(frame1,text='New Run',font=("Arial bold",12),bg='plum3',command=db_add_to_add_running).grid(row=3,column=4,padx=30)
